...
*/
//--------------------------------
// This file contains "command" functions.  Commands are initialized (and 
// these functions are declared) in Commands.h.
//--------------------------------
#include "isxSQLite.h"

// NAME: 'sqlite'
// DESCRIPTION:  This command is simply an easy way to test code while the extension is loaded.
int CMD_TestSQLite(int argc, char *argv[])
{
