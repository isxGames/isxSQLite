...
namespace LavishScript2
{
	...
	typedef bool (__stdcall *fArrayEnum)(unsigned int nValue, class LavishScript2::LS2CodeBoxValue &value, void *pass_thru);
	...
	public:
		...
		virtual unsigned int EnumTypes(LavishScript2::fEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumTypes(LavishScript2::ILS2Table &populate_table)=0;
		...
		virtual void NewString8(unsigned int code_page, const char *text, unsigned int text_partial_length, LavishScript2::ILS2String8 **ppString)=0;
		...
		virtual bool NewString8(unsigned int code_page, const wchar_t *text, unsigned int text_partial_length, LavishScript2::ILS2String8 **ppString, LavishScript2::LS2Exception **ppException)=0;
		...
		virtual bool NewString(unsigned int code_page, const char *text, unsigned int text_partial_length, LavishScript2::ILS2String **ppString, LavishScript2::LS2Exception **ppException)=0;
		...
		virtual bool NewString(unsigned int code_page, const char *text, unsigned int text_partial_length, LavishScript2::LS2CodeBoxValue_String **ppString, LavishScript2::LS2Exception **ppException)=0;
		virtual void NewString(const wchar_t *text, LavishScript2::LS2CodeBoxValue_String **ppString)=0;
		virtual void NewString(const wchar_t *text, unsigned int text_partial_length, LavishScript2::LS2CodeBoxValue_String **ppString)=0;
...
*/
	...
	{
	public:
		LS2Buffer(void *buf, unsigned int buflen);
		virtual ~LS2Buffer();
	...
	{
	public:
		LS2AllocatedBuffer(unsigned int size);
	...
	public:
		...
		virtual bool Resize(unsigned int newSize, LavishScript2::ILS2CodeBoxType *pType_optional, LavishScript2::LS2Exception **ppException)=0;
		...
		virtual bool ResizeBackwards(unsigned int newSize, LavishScript2::ILS2CodeBoxType *pType_optional, LavishScript2::LS2Exception **ppException)=0;

		// retrieve the value at nValue. expected to only return false if nValue is out of range
		virtual bool GetAt(unsigned int nValue, LavishScript2::LS2CodeBoxValue **ppValue)=0;
		// replace the value at nValue. expected to only return false if nValue is out of range
		virtual bool SetAt(unsigned int nValue, LavishScript2::LS2CodeBoxValue &value)=0;

		// create a new spot by pushing toward the end, and set it to this value
		virtual bool InsertAt(unsigned int nValue, LavishScript2::LS2CodeBoxValue &value)=0;
		...
		virtual bool SetRange(unsigned int nValue, unsigned int nLength, LavishScript2::ILS2Array &_array, unsigned int _index)=0;
		...
		virtual bool Enumerate(unsigned int nStartAt, LavishScript2::fArrayEnum enum_func, void *pass_thru)=0;
		...
		template<class T>
		bool GetAt(unsigned int nValue,enum LavishScript2::eLS2CodeBoxValueType value_type,T **ppValue,LavishScript2::LS2Exception **ppException)
		{
	...
	public:
		...
		virtual bool SetField(unsigned int runtime_field_id, LavishScript2::LS2CodeBoxValue &in_value, LavishScript2::LS2Exception **ppException)=0;
		virtual bool GetField(unsigned int runtime_field_id, LavishScript2::LS2CodeBoxValue **ppOutValue, LavishScript2::LS2Exception **ppException)=0;
	...
	public:
		...
		static bool GenerateDeclarationArray(simple_declaration_node *nodes, unsigned int num_nodes, LavishScript2::ILS2Array **ppArray);
	};
	...
	public:
		...
		virtual unsigned int GetLocalFieldID()=0;
		virtual unsigned int GetRuntimeFieldID(LavishScript2::LS2Exception **ppException)=0;
	...
	public:
		...
		virtual bool GetRuntimeFieldID(unsigned int local_field_id, unsigned int &runtime_field_id)=0;
		...
		virtual bool ResolveField(unsigned int local_field_id, LavishScript2::ILS2CodeBoxField **ppOutField)=0;
		...
		virtual unsigned int EnumMethods(LavishScript2::fKeyedEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumStaticMethods(LavishScript2::fKeyedEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumProperties(LavishScript2::fKeyedEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumStaticProperties(LavishScript2::fKeyedEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumFields(LavishScript2::fEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumStaticFields(LavishScript2::fKeyedEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumInterfaces(LavishScript2::fEnumCallback enum_func, void *pass_thru)=0;


		virtual unsigned int EnumMethods(LavishScript2::ILS2Table &populate_table)=0;
		virtual unsigned int EnumStaticMethods(LavishScript2::ILS2Table &populate_table)=0;
		virtual unsigned int EnumProperties(LavishScript2::ILS2Table &populate_table)=0;
		virtual unsigned int EnumStaticProperties(LavishScript2::ILS2Table &populate_table)=0;
		virtual unsigned int EnumFields(LavishScript2::ILS2Array &populate_array)=0;
		virtual unsigned int EnumStaticFields(LavishScript2::ILS2Table &populate_table)=0;
		virtual unsigned int EnumInterfaces(LavishScript2::ILS2Array &populate_array)=0;
