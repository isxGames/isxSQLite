...
#define REGISTER_STATIC_METHOD(_type_,_name_,_cfunction_,_simple_declaration_nodes_) \
	...
	public:
		...
		virtual unsigned int EnumModules(LavishScript2::fEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumModules(LavishScript2::ILS2Table &populate_table)=0;
		...
		virtual unsigned int EnumScripts(LavishScript2::fEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumScripts(LavishScript2::ILS2Table &populate_table)=0;
		...
		virtual unsigned int EnumEvents(LavishScript2::fEnumCallback enum_func, void *pass_thru)=0;
		virtual unsigned int EnumEvents(LavishScript2::ILS2Table &populate_table)=0;
