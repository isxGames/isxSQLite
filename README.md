...
1.  Double-click `isxSQLite.sln` to load the solution in Visual Studio.
2.  Ensure that the build configuration is set to 'Release', which is the default.
3.  Right-click on the isxSQLite project in the Solution Explorer and select "Properties".  Set the "Output Directory" to a valid location for the current configuration.   For 'release', you would want it to be your /innerspace/x64/Extensions/ISXDK35 folder. 
...
Copyright
---------
isxSQLite is Copyright 2011-2026 by [Amadeus@isxGames.com](http://www.isxgames.com/).  Permission to use the source code in this project is granted under the Creative Commons Attribution 3.0 Unported (CC BY 3.0) license.  Visit http://creativecommons.org/licenses/by/3.0/ for a summary of what rights are granted under this license.