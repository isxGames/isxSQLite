...
public:
	...
	// paths
	virtual char *GetLavishScriptPath(char *buffer, unsigned int buflen)=0;
	...
	virtual bool ResolveCommand(char *Text, char *buf,unsigned int buflen)=0;
	virtual void *GetTempBuffer(unsigned int Size, void *CopyFrom=0)=0;
	virtual void AddTempObject(CTempObject *pObject)=0;
	virtual bool RunScriptFromBuffer(char *Name, char *Buffer, unsigned int buflen, int argc=0, char *argv[]=0, char *CWD=0)=0;

	virtual unsigned int AddGlobalAtom(char *Buffer, unsigned int buflen)=0;
	...
	virtual int ExecuteAtom(char *Name,int argc=0, char *argv[]=0, PLSOBJECT pContext=0, char *ReturnBuffer=0, unsigned int buflen=0)=0;
	virtual int ExecuteAtom(char *ScriptName, char *Name,int argc=0, char *argv[]=0, PLSOBJECT pContext=0, char *ReturnBuffer=0, unsigned int buflen=0)=0;
	...
	virtual bool GetScriptCWD(char *ScriptName, char *buffer, unsigned int buflen)=0;
	...
	virtual unsigned int AddAtom(char *ScriptName, char *Buffer, unsigned int buflen)=0;
	...
	virtual char *Escape(char *text, char *buf, int buflen)=0;
	virtual char *EscapeQuotes(char *text, char *buf, int buflen)=0;
